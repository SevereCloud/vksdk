...
VK имеет модифицированный FOAF, который был сделан по примеру яндекса + добавили свои тэги(некоторых тэгов нет в документации). К сожалению документация яндекса потяралась во времени ([archive](https://web.archive.org/web/20140909053226/http://api.yandex.ru/blogs/doc/indexation/concepts/what-is-foaf.xml)).
