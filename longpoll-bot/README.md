...
[![VK](https://img.shields.io/badge/developers-%234a76a8.svg?logo=VK&logoColor=white)](https://dev.vk.ru/ru/api/bots-long-poll/getting-started)
...
Полный список событий Вы найдёте [в документации](https://dev.vk.ru/ru/api/community-events/json-schema)
