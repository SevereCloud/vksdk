...
// Attachments List of media objects attached to the topic, in the following format: <owner_id>_<media_id>,<owner_id>_<media_id>
//
...
// TopicIDs IDs of topics to be returned (100 maximum).
//
// By default: all topics are returned.
// If this parameter is set, the 'order'
//
// *  'offset' and 'count' parameters are ignored.
