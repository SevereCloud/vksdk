...
// Code - country codes in [vk.ru/dev/country_codes|ISO 3166-1 alpha-2] standard.
...
// CountryID parameter, received in [vk.ru/dev/database.getCountries|database.getCountries] method.
