...
// Use negative value for a community id.
// If the 'type' parameter is not set, the 'owner_id' is assumed to be either the current user or the same application ID as if the 'type' parameter was set to 'sitepage'.
...
// ItemID Object ID.
// If 'type' is set as 'sitepage'
//
// *  'item_id' can include the 'page_id' parameter value used during initialization of the [vk.com/dev/Like|Like widget].
func (b *LikesGetListBuilder) ItemID(v int) *LikesGetListBuilder{
	b.Params["item_id"] = v
	return b
}

// PageURL URL of the page where the [vk.com/dev/Like|Like widget] is installed.
// Used instead of the 'item_id' parameter.
