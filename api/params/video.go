...
// PrivacyView privacy settings in a [vk.ru/dev/privacy_setting|special format].
...
// PrivacyComment privacy settings for comments in a [vk.ru/dev/privacy_setting|special format].
