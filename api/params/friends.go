...
// Follow parameter '1' to pass an incoming request to followers list.
...
// UserID User ID.
//
// By default: the current user ID.
...
// ListID ID of the friend list returned by the [vk.com/dev/friends.getLists|friends.getLists] method to be used as the source.
...
// Phones List of phone numbers in MSISDN format (maximum 1000).
// Example: +79219876543,+79111234567
...
// ListID Friend list ID.
// If this parameter is not set, information about all online friends is returned.
