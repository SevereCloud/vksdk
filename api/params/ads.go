...
//
// * countries — request of a list of countries.
// If q is not set or blank, a short list of countries is shown.
// Otherwise, a full list of countries is shown.
//
// * regions — requested list of regions.
// 'country' parameter is required.
//
// * cities — requested list of cities.
// 'country' parameter is required.
//
// * districts — requested list of districts.
// 'cities' parameter is required.
//
// * stations — requested list of subway stations.
// 'cities' parameter is required.
//
// * streets — requested list of streets.
// 'cities' parameter is required.
//
// * schools — requested list of educational organizations.
// 'cities' parameter is required.
//
...
// Lifetime parameter 'Only for the groups that get audience from sites with user accounting code.'
