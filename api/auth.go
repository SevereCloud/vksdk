...
func (vk *VK) AuthCheckPhone(params map[string]string) (response int, err error) {
...
func (vk *VK) AuthRetore(params map[string]string) (response AuthRetoreResponse, err error) {
