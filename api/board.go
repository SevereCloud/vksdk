...
//
// https://dev.vk.ru/method/board.addTopic
...
//
// https://dev.vk.ru/method/board.closeTopic
...
//
// https://dev.vk.ru/method/board.createComment
...
//
// https://dev.vk.ru/method/board.deleteComment
...
//
// https://dev.vk.ru/method/board.deleteTopic
...
//
// https://dev.vk.ru/method/board.editComment
...
//
// https://dev.vk.ru/method/board.editTopic
...
//
// https://dev.vk.ru/method/board.fixTopic
...
//	extended=0
//
// https://dev.vk.ru/method/board.getComments
...
type BoardGetTopicsResponse struct {
	...
	DefaultOrder float64             `json:"default_order"` // BUG(VK): default_order int https://vk.ru/bug136682
...
//	extended=0
//
// https://dev.vk.ru/method/board.getTopics
...
//
// https://dev.vk.ru/method/board.openTopic
...
//
// https://dev.vk.ru/method/board.restoreComment
...
//
// https://dev.vk.ru/method/board.unfixTopic
